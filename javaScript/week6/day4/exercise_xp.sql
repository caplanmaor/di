...
-- 4. Write a query to get the names (first_name, last_name), salary and
-- 15% of salary as PF (ie. alias) for all the employees.

-- SELECT salary*0.15 AS PF, first_name,last_name,salary from employees 

-- 5. Write a query to get the employee IDs, names (first_name,
-- last_name) and salary in ascending order according to their salary.
...
-- 13. Write a query to get the first name, last name and the length of the f
-- ull name of all the employees from the employees table.

-- SELECT first_name, last_name,LENGTH(CONCAT(first_name, last_name)) AS fullname_length FROM employees

-- 14. Write a query to check whether the first_name 
-- column of the employees table contains any numbers.
...
-- 1. Write a query to display the first_name, last_name and salary of all 
...
-- SELECT * FROM employees WHERE hire_date BETWEEN '1987-01-01' AND '1987-12-31'
...
-- 5. Write a query to display the last names of all employees whose 
...
-- 7.Write a query to display the jobs/designations 
-- available in the employees table.

-- SELECT DISTINCT job_title FROM employees
-- INNER JOIN  jobs ON jobs.job_id = employees.job_id
-- WHERE EXISTS (SELECT job_title FROM employees)

-- 8. Write a query to select all information of employees 
-- whose last name is either ‘JONES’ or ‘BLAKE’ or ‘SCOTT’ 
-- or ‘KING’ or ‘FORD’.

-- SELECT * FROM employees WHERE last_name = 'Jones' OR last_name = 'Blake'
-- OR last_name = 'Scott'
-- OR last_name = 'King'
-- OR last_name = 'Ford'
